...
async def message(ctx):
  ...
  messages = ['Hey', 'What is your fav game?', 'anyone got some movie suggestions?', 'Who is the best streamer to watch?', 'Anyone else outta school now?', 'You guys like Drake?','Whats good','Up up upitty', 'Suggest me some shows','Im going to the store, anyone need anything?','Im a fortnite prodigy','Im cool','Nice weather out huh?','where you guys from?', 'Tell me something interesting', 'Tell a joke', 'Anyone need some advice?', 'Favorite actor?','Whats the best game out rn?','whats ur favorite soccer club?',"how is coronacation for y'all", 'You guys play CSGO?','Howmany hours you guys got in the game?','Is mark zuckerberg a lizard?','What GPU u guys got?','You guys fw 21 savage?', 'Who is your idol?','you guys blaze?','Rip x']
